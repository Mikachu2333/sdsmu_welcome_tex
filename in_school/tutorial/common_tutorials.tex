...
\begin{enumerate}
    ...
    \item 本楼层小浴室使用：
          \begin{enumerate}
              ...
              \item 进入浴室，点击如右图所示的按钮（\mbox{\includegraphics[height=2.4ex]{resources/sundry/bath.pdf}}）→选择“蓝牙设备”→“点击进行时”
...
\subsection[档案远程服务利用系统（学校）]{档案远程服务利用系统（学校）}
\begin{enumerate}
    ...
    \item 其他注意事项详见官网
\end{enumerate}
\subsection[高校档案查询利用平台]{高校档案查询利用平台}
\begin{enumerate}
