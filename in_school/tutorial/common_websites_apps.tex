...
\begin{enumerate}
    ...
    \item 康复医学院：\uhref{https://kfyxy.sdsmu.edu.cn}{https://kfyxy.sdsmu.edu.cn}
...
\begin{enumerate}
    ...
    \item 安全中心：\uhref{https://cas.sdsmu.edu.cn:4102}{https://cas.sdsmu.edu.cn:4102}
    \item 校园邮箱（SSL安全登录）：\uhref{https://edu.icoremail.net}{https://edu.icoremail.net}
    \item 校园邮箱（普通登录）：\uhref{https://mail.stu.sdsmu.edu.cn}{https://mail.stu.sdsmu.edu.cn}
\end{enumerate}
...
\begin{enumerate}
    ...
    \item 资源访问控制系统（VPN）：\uhref{https://webvpn.sdsmu.edu.cn}{https://webvpn.sdsmu.edu.cn}
    \item 统一身份认证平台：\uhref{https://cas.sdsmu.edu.cn}{https://cas.sdsmu.edu.cn}
    \item 网上办事大厅（事务中心）：\uhref{https://portal.sdsmu.edu.cn}{https://portal.sdsmu.edu.cn$^㊕$}
\end{enumerate}
...
\subsection[课程表软件]{课程表软件}
\label{schedule_app}
推荐“山二医App”，次选“Wakeup课程表”
