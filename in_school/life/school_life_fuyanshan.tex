...
\begin{enumerate}
    ...
    \item 推荐网购，也可根据\hyperref[free_bus]{后文}的公交车信息前往大型商超购置
...
\begin{table}[H]
    ...
    \begin{tblr}[
        ...
        中和/大服超市 & \hyperref[market_fuyanshan]{见此} & 最少 & 一般 & 一般
    \end{tblr}
\end{table}
...
\begin{enumerate}
    ...
    \item 可通过13、169、路等公交车（北门乘坐）或13、109路等公交车（南门乘坐）前往市区（如泰华、万达、谷德茂等）游玩\footnotemark
          \footnotetext{详情公交信息与免费乘车指南参见\hyperref[free_bus]{此处}。}
    \item 文体中心（位置参见\hyperref[map_fuyanshan_holistic]{此处}）内有羽毛球馆、篮球馆（两者互斥）、健身房，还有\textbf{游泳馆}等\footnotemark
          \footnotetext{具体收费标准及预约方式见\hyperref[sports_center_book]{下文}，开放时间\hyperref[sports_center_operating_hours]{见此}。}
\end{enumerate}
