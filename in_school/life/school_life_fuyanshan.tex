...
\begin{enumerate}
    ...
    \item 推荐网购，也可根据\uref{free_bus}小节的公交车信息前往大型商超购置
...
杏林餐厅全部三层均有大量食物，大多物美价廉。\textbf{\uul{需要自己收拾碗筷！}}
...
\begin{table}[H]
    ...
    \begin{tblr}[
        ...
        中和/大服超市 & 见地图\uref{market_fuyanshan} & 最少 & 一般 & 一般
    \end{tblr}
\end{table}
...
\begin{enumerate}
    ...
    \item 前往市区的公交线路详参见\uref{free_bus}小节
    \item 文体中心（位置见地图\uref{map_fuyanshan_holistic}）内有羽毛球馆、篮球馆（两者互斥）、健身房，还有\textbf{游泳馆}等\footnotemark
          \footnotetext{具体收费标准及预约方式见\uref{sports_center_book}，开放时间见下表。}
\end{enumerate}
...
\begin{enumerate}
    ...
    \item 出租房：附近小区有较多房屋出租（学校\textbf{严禁学生擅自在校外住宿}，确有特殊原因需在校外住宿的，必须严格履行审批手续\footnotemark）
          \footnotetext{需家长同意并到校说明相关情况，申请的有效期不超一年且不可跨学年，详情政策请咨询学工办。}
\end{enumerate}
...
\begin{tblr}[
    ...
    大服     & 厕所                       & --1层东北      & 略                                       \\*
             ...
             & 智慧驾校                   & 2层西北        & 驾考咨询、驾校报名                       \\*
             & 理发店（三家）             & 2层            & 烫染剪发                                 \\*
             & 复印店\TblrNote{1}（两家） & 2层            & \textbf{打印复印扫描、证件照}、 复习资料 \\*
             & 电信营业厅                 & 2层            & 电信业务办理                             \\*
             & 移动业务咨询处             & 2层东          & 移动业务咨询                             \\*
             & 广电营业厅                 & 2层北          & 广电业务办理                             \\*
    ...
    中和广场 & 学生印务                   & A106对过       & 打印复印扫描、\textbf{复习资料、二手书}  \\*
             & 移动营业厅                 & A104对过       & 移动业务办理                             \\*
             & 酷跑文印社\TblrNote{3}     & A103对过       & 打印复印扫描                             \\
