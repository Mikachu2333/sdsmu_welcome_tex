...
\subsection[档案查询系统]{档案查询系统}
\begin{enumerate}
    \item 官网：\uline{\href{http://dangan.sdsmu.edu.cn/services-utilization/web/management/index}{http://dangan.sdsmu.edu.cn/services-utilization/web/management/index}}
    \item 业务范围：
    \begin{enumerate}
        \item 招生录取名册（学生登记表）
        \item 学生成绩
