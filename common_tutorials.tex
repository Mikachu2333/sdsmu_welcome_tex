...
\footnotetext{本节中的所有网址仅在校内链接校园网时可成功访问。}
\begin{enumerate}
...
\begin{enumerate}
    ...
    \footnotetext{详情优惠政策可咨询营业厅，如追求更多流量建议学校各账号不绑定校园手机卡，每年根据新优惠政策调整手机卡（需注意注销旧手机卡以防欠费导致的信用记录问题）。}
