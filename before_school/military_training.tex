...
\begin{enumerate}
    ...
    \item 着装：穿着统一的军训套装\footnotemark
          \footnotetext{同被褥套装订购教程，参见\uref{freshman_query}{此处}。含T恤、外套、裤子（很肥）、腰带（扎在外套外面，需另备一条腰带以免掉裤子）、鞋子（底薄、磨脚，推荐鞋子大一号多垫几双鞋垫）和马扎（军训完不要扔，考试月背书很好用）。}
    \item \textbf{如果因为身体原因不能参加军训，需要提前拿病历、住院证明等材料前往校医院开具相关证明\label{exercise_unattend}}（位置\uref{map_fuyanshan_holistic}{见此}）
