...
\begin{enumerate}
    ...
    \item 本楼层小浴室使用：
          \begin{enumerate}
              ...
              \footnotetext[3]{搜索不到设备请务必开启“蓝牙”功能，学校的设备无法扫码连接。}
...
\begin{enumerate}
    ...
    \footnotetext{原“请假审批、外出审批”工作已基本转移至“钉钉”，详见\uline{text}。}
    \item 使用方式：
    \begin{enumerate}
        \item 在微信搜索“智慧学工”小程序
        \item 授予“定位”权限
...
\begin{enumerate}
    ...
    \footnotetext{羽毛球等多人竞技项目预约方式为：单人预约，多人共享。详情可咨询负责相关场馆的教师。}
    \item 费用：
    \begin{enumerate}
        \item 健体中心：3元/2小时
