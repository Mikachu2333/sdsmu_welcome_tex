...
\title{潍坊医学院新生入学指南（浮烟山校区）\footnotemark}
\footnotetext[1]{第1.1.3版，由\textit{\LaTeX} 的\textit{\LaTeXe} 版本生成。}
\author{Mika\thanks{\uline{\href{Mailto:xkjz.mddb@yandex.com}{Mailto: xkjz.mddb@yandex.com}}}\and 潍坊医学院表白墙QQ频道}
\date{\DTMnow}
\maketitle
