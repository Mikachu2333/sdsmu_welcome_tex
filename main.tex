...
\usepackage[final=true, colorlinks, hidelinks, bookmarks, bookmarksnumbered=true, allbordercolors={0 0 0}, pdfborderstyle={/S/U/W 1}]{hyperref}%超链接
%下一步计划使用hyperref全面代替ulem（参数：allbordercolors={0 0 0},pdfborderstyle={/S/U/W 1}）
