...
% 山东第二医科大学入学与生活指南 © 2023-2025 by LinkChou is licensed under CC BY-SA 4.0. To view a copy of this license, visit https://creativecommons.org/licenses/by-sa/4.0 . Chinese version: https://creativecommons.org/licenses/by-sa/4.0/deed.zh-hans .

% 导入所需的package
\DocumentMetadata{pdfversion=1.7, pdfstandard=A-3u, lang=zh-CN}%hook引入与语言设置
\tagpdfsetup{math/mathml/luamml/load=false} %消除Warning
...
% 重定义文章字体为Noto Serif CJK SC
\setmainfont[CharacterWidth=Proportional,BoldFont=NotoSerifCJKsc-Bold.otf]{NotoSerifCJKsc-Regular.otf}
\setCJKmainfont{NotoSerifCJKsc-Regular.otf}[BoldFont=NotoSerifCJKsc-Bold.otf]
\setCJKsansfont[BoldFont=NotoSerifCJKsc-Bold.otf]{NotoSerifCJKsc-Regular.otf}
\setCJKmonofont[BoldFont=NotoSerifCJKsc-Bold.otf]{NotoSerifCJKsc-Regular.otf}
...
% 潍医红：CYMK(10,100,100,40) 或 RGB(154,0,4)
\newcommand{\colorSpecial}[1]{
    \textcolor[RGB]{154,0,4}{#1}
}
