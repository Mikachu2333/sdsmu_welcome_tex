...
\usepackage[showseconds=true]{datetime2}
...
\author{Mika\thanks{\uline{\href{Mailto:xkjz.mddb@yandex.com}{Mailto: xkjz.mddb@yandex.com}}}\and 潍坊医学院表白墙QQ频道\thanks{第1.0.8版，由\LaTeX 的\LaTeXe 版本生成}}
\date{\DTMnow}
\maketitle
